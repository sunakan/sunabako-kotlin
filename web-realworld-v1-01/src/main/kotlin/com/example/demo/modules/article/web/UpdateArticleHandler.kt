...
// - 対象の記事の著者である
//
// $ curl -X PUT --header 'Content-Type: application/json' -d '{"article":{"title":"How to train your dragon", "description":"Ever wonder how?", "body":"Very carefully.", "tagList":["training", "dragons"]}}' 'http://localhost:8080/api/articles' | jq '.'
@RestController
